...
class const_iterator{
 public:
  //    const_iterator(typename std::set<std::shared_ptr<Node<T>>, CustomCompare<Node<T>>> &nodes, const std::string iterType) :
  //      iterType_(iterType) {
  //
  //        if(iterType == "begin"){
  //            iter_ = nodes.begin();
 ...
 explicit const_iterator(typename std::set<std::shared_ptr<Node<T>>, CustomCompare<Node<T>>> &nodes):
  iter_{nodes.begin()} {};
